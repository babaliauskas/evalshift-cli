...
class TestValidateSuiteAgainstPrompts:
    def test_happy_path_every_pair_compatible(self) -> None:
        suite = Suite(
            examples=[
                suite_example(id="ex1", inputs={"name": "Alex", "tone": "formal"}),
                suite_example(id="ex2", inputs={"name": "Sam", "tone": "casual"}),
            ],
        )
    ...
    def test_one_missing_var_in_one_example(self) -> None:
        suite = Suite(
            examples=[
                suite_example(id="ex1", inputs={"name": "Alex"}),
                suite_example(id="ex2", inputs={"name": "Sam", "tone": "casual"}),
            ],
        )
    ...
    def test_multiple_issues_collected_at_once(self) -> None:
        suite = Suite(
            examples=[
                suite_example(id="ex1", inputs={}),
                suite_example(id="ex2", inputs={"a": 1}),
            ],
        )
        templates = [
    ...
    def test_declared_variables_treated_as_required(self) -> None:
        ...
        suite = Suite(
            examples=[suite_example(id="ex1", inputs={"name": "Alex"})],
        )
    ...
    def test_extra_inputs_in_example_are_allowed(self) -> None:
        suite = Suite(
            examples=[suite_example(id="ex1", inputs={"name": "Alex", "extra": "ok"})],
        )
