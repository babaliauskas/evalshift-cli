"""Implementation of ``aimigrate evaluate <run-id>``.
...
from aimigrate.evaluators.llm_judge import PairwiseJudgeEvaluator
from aimigrate.evaluators.semantic import CosineSimilarityEvaluator
...
def evaluate(
    ...
    if not evaluators:
        console.print(
            ...
            "[bold]evaluators:[/bold] in aimigrate.yaml.",
        )
