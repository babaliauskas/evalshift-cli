...
Most tags on a :class:`~evalshift_cli.suite.models.SuiteExample` come from the
...
(:mod:`evalshift_cli.captures.promote`) and the readers agree on the literal.
...
:func:`evalshift_cli.analysis.slicing.dedupe_slices`.
"""
