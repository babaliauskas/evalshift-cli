...
(``<base>/toolsets/<hex>.json`` -- see :func:`evalshift_cli.captures.reader.toolset_path`) and
...
:class:`evalshift_cli.evaluators.tool_models.ToolSpec`, whose wire format is the same three fields.
