...
orchestrator runs automatically after each completed run (:func:`evalshift_cli.runner.checkpoint.prune_runs`),
...
from evalshift_cli.config.models import Retention
from evalshift_cli.runner.checkpoint import prune_runs, resolve_max_runs
