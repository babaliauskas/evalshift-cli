...
from evalshift_cli.runner.models import RunState
...
class Facts:
    ...
    #: measures nothing (:attr:`~evalshift_cli.analysis.policy.BudgetResult.measured`).
    ...
    #: :func:`~evalshift_cli.analysis.policy.unmeasured_gating_evaluators`.
