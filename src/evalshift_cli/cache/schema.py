...
class CachedCall(Base):
    ...
    Attributes:
        cache_key: SHA-256 hex digest of the canonicalised request. The
            primary key. See :func:`evalshift_cli.cache.store.cache_key`.
        model_id: The canonical model id used for the call (matches
            :attr:`evalshift_cli.models.registry.ModelMetadata.id`).
        ...
        finish_reason: The provider's normalised stop reason at write time.
            Nullable — ``"length"`` means the cached response was truncated,
